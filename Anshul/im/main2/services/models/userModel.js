...
const constants = require('../configs/constants.json')
	...
	, apiAccessTokenName = constants.user.apiAccessTokenName
	, apiRefreshTokenName = constants.user.apiRefreshTokenName
	, apiAccessTokenLength = constants.user.apiAccessTokenLength
	, apiRefreshTokenLength = constants.user.apiRefreshTokenLength
