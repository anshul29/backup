...
var ListItem = Reacr.createClass({
    render: function () {
        return React.createElement(
            'li',
            null,
...
var ListManager = React.createClass({
    ...
    handleSubmit: function (e) {
        ...
        currentItems.push(this.state.items);
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('input', { onChange: this.onChange, value: this.state.newTextitem }),
                React.createElement(
                    'button',
                    null,
                    'Add'
            ...
            React.createElement(List, { items: this.state.itmes })
        );
    }
});
...
ReactDOM.render(React.createElement(ListManager, { titile: 'Ingredients' }), document.getElementsById('ingridents'));
